...
准备 `txt` 文件, 里面有编号列和打乱列. 在Chrome中打开 [https://or18.github.io/RubiksSolverDemo/](https://or18.github.io/RubiksSolverDemo/) , 按 `F12` 打开控制台, 执行 `batch_cross_analyzer.js` 中的代码, 弹窗时选择 `txt` 文件, 每计算2000行会得到一个`csv`.
